...
$sql_user = "select * from user where admin='" . $_COOKIE["email"] . "'";
...
if (isset($_POST['kt_new_user_submit'])) {
    $sql = "insert into user value (null,'" . $_POST["phone"] . "','" .  $_POST["name"] . "','" .  $_POST["password"] . "','" . $_COOKIE['email'] . "')";
    if ($result = mysqli_query($conn, $sql)) {
        header("Location: user");
    } else
        echo 'Failed.' . mysqli_error($conn);
...
if (isset($_POST['kt_edit_user_submit'])) {
    $sql = "update user set user_phone ='" . $_POST["phone_edit"] . "', user_name='" . $_POST["name_edit"] . "', user_password='" . $_POST["password_edit"] . "' where user_id='" . $_POST["user_edit"] . "'";
    if ($result = mysqli_query($conn, $sql)) {
        header("Location: user");
    } else
        echo 'Failed.' . mysqli_error($conn);
...
<body id="kt_body" style="background-image: url(../assets/media/patterns/header-bg.png)" class="toolbar-enabled">
                                            ...
                                            <table id="table_user" class="table table-striped hover" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="px-3" style="font-weight:bold">Name</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                                <tr>
                                                                    <td class="px-3"><?php echo $row["user_phone"]; ?></td>
                                                                    <td class="px-3"><?php echo $row["user_name"]; ?></td>
                                                                    <td class="px-3"><?php echo $row["user_password"]; ?></td>
                                                                    ...
                                                                    <td class="pe-0 text-center">
                                                                        ...
                                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true" style="">
                                                                            ...
                                                                            <!--begin::Menu item-->
                                                                            <div class="menu-item px-3">
                                                                                <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_edit_user" onclick="javascript:editUser('<?php echo $row['user_id']; ?>','<?php echo $row['user_phone']; ?>','<?php echo $row['user_name']; ?>','<?php echo $row['user_password']; ?>')">Bearbeiten</a>
                                                                            </div>
                                                                            <!--end::Menu item-->
                                                                            <!--begin::Menu item-->
                                                                            <div class="menu-item px-3">
                                                                                <a href="?action=delete&id=<?php echo $row["user_id"]; ?>" class="menu-link flex-stack px-3">Löschen
                                                                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="" data-bs-original-title="Alle buchungen dieses benutzers werden gelöscht" aria-label="Alle buchungen dieses benutzers werden gelöscht"></i></a>
                                                                            </div>
                                                                            <!--end::Menu item-->
                                                                        </div>
                                                                    </td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body py-lg-5 px-lg-5">
                        ...
                        <div class="fv-row mb-10 fv-plugins-icon-container">
                            <!--begin::Label-->
                            <label class="form-label fs-6 fw-bold text-dark">Tel</label>
                            <!--end::Label-->

                            <!--begin::Input-->
                            <input class="form-control form-control-lg form-control-solid" type="text" id="phone" name="phone" autocomplete="off" />
                            <!--end::Input-->
                        ...
                        <div class="fv-row mb-10 fv-plugins-icon-container">
                            ...
                            <!--begin::Input-->
                            <input class="form-control form-control-lg form-control-solid" type="text" id="name" name="name" autocomplete="off" />
                            <!--end::Input-->
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="mt-5">
                            ...
                            <button type="submit" id="kt_new_user_submit" name="kt_new_user_submit" class="btn btn-lg btn-primary my-2" data-kt-stepper-action="submit">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body py-lg-5 px-lg-5">
                        ...
                        <div class="fv-row mb-10 fv-plugins-icon-container">
                            ...
                            <!--begin::Input-->
                            <input class="form-control form-control-lg form-control-solid" type="hidden" id="user_edit" name="user_edit" autocomplete="off" />
                            <input class="form-control form-control-lg form-control-solid" type="text" id="phone_edit" name="phone_edit" autocomplete="off" />
                            <!--end::Input-->
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-10 fv-plugins-icon-container">
                            ...
                            <!--begin::Input-->
                            <input class="form-control form-control-lg form-control-solid" type="text" id="name_edit" name="name_edit" autocomplete="off" />
                            <!--end::Input-->
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="mt-5">
                            ...
                            <button type="submit" id="kt_edit_user_submit" name="kt_edit_user_submit" class="btn btn-lg btn-primary my-2" data-kt-stepper-action="submit">
                                <span class="indicator-label">Speichern
  ...
  <script src="../assets/js/custom/widgets.js"></script>-->
        <script>
            ...
            function editUser(id, phone, name, password) {
                document.getElementById("user_edit").value = id;
