...
class GoogleCalendarApi
{
    ...
    public function GetAccessTokenRefresh($client_id, $redirect_uri, $client_secret, $refresh_token)
    {
    ...
    public function GetCalendarEvent($calendar_id, $access_token)
    {
        $url_events = 'https://www.googleapis.com/calendar/v3/calendars/' . $calendar_id . '/events?timeMin=' . date("Y-m-d") . "T00:00:00.000Z";
        $ch = curl_init();
